          ...
          <div className="w-full lg:flex-1">
            <div className="relative">
              ...
              <div className="relative z-10 transform hover:scale-[1.02] transition-transform duration-500">
                <Image 
                  src="/media/concept/palestra-imersao.png" 
              ...
              <div className="absolute -bottom-6 -left-6 lg:left-auto lg:-right-6 bg-white p-4 rounded-2xl shadow-xl z-20 hidden sm:flex items-center gap-3 border border-slate-100">
